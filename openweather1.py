...
ACCESS_TOKEN = "6OSgcOCEIWMT07HpD0Ri"  # Mã thông báo để xác thực thiết bị trên ThingsBoard
...
def get_weather_data():
   ...
   if response.status_code == 200:
       ...
       # Chuyển độ Kelvin sang độ Celsius và lấy thông tin thời tiết
...
def send_data(client):
   ...
   temperature, humidity, pressure, wind_speed, wind_direction = get_weather_data()
  
   # Nếu thông tin thời tiết có sẵn
   if all(v is not None for v in [temperature, humidity, pressure, wind_speed, wind_direction]):
       ...
       sensor_data = {
           ...
           "longitude":105.78280958309838,
           "latitude": 21.038587698930247
       }
